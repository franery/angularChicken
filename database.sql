...
insert into Gallinero(nombre,idUsuario,stockGallinas) values ('Gall1',13,50),('Gall2',13,60);
insert into Movimiento(fecha,cantidad,idGallinero,idDeposito) values ('2000-11-11',20,9,3),('2000-11-12',30,10,4);
